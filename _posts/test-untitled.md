...
3. In the Cartesian coordinate system, $$\vec{e}$$ is a unit vector. If the vector $$\vec a$$ satisfies the two conditions $$\vec a\cdot \vec e=2$$ and 
...
9. *(16 points)* In $$\triangle ABC$$, $$BC=a$$, $$CA=b$$, and $$AB=c$$. Given $$b$$ is the geometric mean of $$a$$ and $$c$$ and $$\sin A$$ is the arithmetic mean of $$\sin(B-A)$$ and $$\sin C$$, find the value of $$\cos B$$. 
...
9. *(16 points)* In an ellipse $$\Gamma$$, $$F$$ is a focus and $$A,B$$ are two of the vertices. Given that $$FA=3$$ and $$FB=2$$, find all possible values of $$AB$$.
